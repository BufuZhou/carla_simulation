...
ControlNode::ControlNode() : Node("control"), count_(0) {
  ...
  //     this->create_subscription<ros_msgs::msg::Trajectory>(
  //         "/planning/trajectory", 10,
  //         std::bind(&ControlNode::get_trajectory, this, _1));

  // localization_subscriber_ = this->create_subscription<ros_msgs::msg::Pose>(
...
// void ControlNode::get_trajectory(ros_msgs::msg::Trajectory::SharedPtr msg) {
//   has_subscribed_trajectory_ = true;
//   trajectory_.poses = msg->poses;
// }

// void ControlNode::get_localization(ros_msgs::msg::Pose::SharedPtr msg) {
...
void ControlNode::send_vehicle_command() {
  ...
  carla_vehicle_command_.steer = 0.0;
  carla_vehicle_command_.throttle = 0.5;
